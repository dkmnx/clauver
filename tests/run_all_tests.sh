...
declare -A TEST_CATEGORIES=(
    ...
    ["crypto_module"]="test_crypto_module.sh"
...
main() {
    case "${1:-all}" in
        "all")
            ...
            generate_test_report
            ;;
        "utilities"|"ui_module"|"validation_module"|"config_module"|"crypto_module"|"encryption"|"security"|"security_hardening"|"providers"|"integration"|"error_handling"|"performance")
