...
test_banner_function() {
    ...
    assert_contains "$banner_output" "v1.6.1" "banner() should display version 'v1.6.1'"

    # Test with empty provider
    local empty_banner
    empty_banner=$(banner "")
    assert_contains "$empty_banner" "v1.6.1" "banner() should display version even with empty provider"
