...
test_banner_function() {
    ...
    assert_contains "$banner_output" "v1.11.2" "banner() should display version 'v1.11.2'"

    # Test with empty provider
    local empty_banner
    empty_banner=$(banner "")
    assert_contains "$empty_banner" "v1.11.2" "banner() should display version even with empty provider"
